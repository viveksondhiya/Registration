...
const ServicesSec = () => {
  return (
    <div>
      <div className="flex lg:flex-col h-[600px] xl:h-[400px] lg:h-auto lg:justify-start justify-evenly " id="services">
            <div className="mt-5 mr-[10px] lg:mr-0  w-full pic6 bg-left-top bg-cover max-h-[600px] lg:min-h-[250px] lg:w-auto "></div>
            <div className="bg-[rgb(245,245,245)] text-center mt-[20px] ml-[10px] lg:ml-0  w-full max-h-[600px] lg:w-auto lg:h-auto lg:pb-5 ">
                <h2 className="my-[5px] font-sans text-[42px] xl:text-[32px] md:text-[28px] md:leading-[27px] xl:leading-[31px] leading-10 font-bold tracking-[-3px] pt-[90px] xl:pt-9 pb-[5px] ">
                    Things <br/>we do</h2>
                <h5 className="mt-[5px] font-serif leading-[22px] text-base italic font-normal  ">We exist to create</h5>
