...
const LastBox = () => {
  return (
    <div>
      <div className="bg-[rgb(245,245,245)] text-center mt-5 pt-10 pb-[50px] px-[50px] ml-[10px] xl:h-auto xl:pt-0 xl:px-5 hover:bg-[#bbc4c7] box-tran">
                <img src={p10} className="w-[125px] m-auto"/>
                <h2 className="my-[5px] font-sans text-[42px] xl:text-[32px] md:text-[28px] md:leading-[27px] xl:leading-[31px] leading-10 font-bold tracking-[-3px]">Graphic Design</h2>
